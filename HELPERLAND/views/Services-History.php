                ...
                <div class="collapse navbar-collapse mynav" id="mynav">
                    <ul class="navbar-nav ml-auto text-center">
                        ...
                        <li class="nav-item" id="notification">
                            <a href="#" class="nav-link"><img src="../assets/img/icon-notification.png" alt=""><span class="notification-no">2</span></a></li>
        ...
        <div class="row">
            <div class="col-lg-3">
                <nav class="vertical-nav navbar-expand-lg  " id="sidebar">
                    ...
                    <div class="collapse navbar-collapse text-xl-left text-lg-center mynav "
                        id="navbarSupportedContents3">
