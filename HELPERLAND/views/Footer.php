...
<section class="footer">
    <div class="container">
      <div class="row justify-content-center py-4 d-flex align-content-center">
        ...
        <div class="col-lg-2 py-4 text-center">
          <a href="#"><img src="../assets/img/face.png" alt="fb" class="px-2"></a>
          <a href="#"><img src="../assets/img/instagram.png"   alt="insta" class="px-2"></a>
        </div>
      </div>
